...
<table>
  <thead>
    <tr>
      <th>Metric</th>
      <th>Manual Audit</th>
      <th>CarbonSite Audit</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><strong>Time to prepare evidence</strong></td>
      <td>3–4 weeks</td>
      <td>30 minutes (export)</td>
    </tr>
    <tr>
      <td><strong>Time for auditor verification</strong></td>
      <td>3–4 weeks</td>
      <td>2–3 hours</td>
    </tr>
    <tr>
      <td><strong>Cost of audit delays</strong></td>
      <td>$50–100k</td>
      <td>&lt;$5k</td>
    </tr>
    <tr>
      <td><strong>Auditor confidence</strong></td>
      <td>Moderate (trust-based)</td>
      <td>High (mathematically proven)</td>
    </tr>
  </tbody>
</table>
