...
| Organization Size | Records | Dashboard Load | Filter | Export |
|---|---|---|---|---|
| **Startup** | 10k | 200ms | 150ms | 500ms |
| **Mid-market** | 100k | 300ms | 200ms | 1.2s |
| **Enterprise** | 1M | 400ms | 250ms | 2.5s |
...
| Platform | 100k Records | 1M Records | Architecture |
|---|---|---|---|
| **CarbonSite** | 300ms | 400ms | Pre-computed aggregates |
| **Persefoni** | 500ms | 1.2s | Partial caching |
| **Watershed** | 400ms | 900ms | Query optimization |
| **Gaia** | 2s | Timeout | No optimization |
