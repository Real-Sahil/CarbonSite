...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>SupplyCo</td>
      <td>Submitted</td>
      <td>Emissions 5x normal (typo in zeros?)</td>
    </tr>
    <tr>
      <td>LocalVendor</td>
      <td>Submitted</td>
      <td>40% fields blank (missing production data)</td>
    </tr>
    <tr>
      <td>TierTwo</td>
      <td>Submitted</td>
      <td>Date is in the future (2025)</td>
    </tr>
    <tr>
      <td>Subcontractor</td>
      <td>Submitted</td>
      <td>Same data as last quarter (copy-paste?)</td>
    </tr>
    <tr>
      <td>MissingCo</td>
      <td>No response</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>50 suppliers</td>
      <td>Auto-detect anomalies</td>
      <td>System</td>
    </tr>
    <tr>
      <td><strong>Flagged</strong></td>
      <td>3 suspicious, 2 incomplete</td>
      <td>Request corrections</td>
      <td>Procurement</td>
    </tr>
    <tr>
      <td><strong>Corrected</strong></td>
      <td>+5 suppliers now usable</td>
      <td>Accept corrected data</td>
      <td>System</td>
    </tr>
    <tr>
      <td><strong>Unresponsive</strong></td>
      <td>45 suppliers (original 50)</td>
      <td>Use ML estimation</td>
      <td>System</td>
    </tr>
    <tr>
      <td><strong>Final</strong></td>
      <td>10 actual + 40 estimated</td>
      <td>Publish with transparency</td>
      <td>Report</td>
    </tr>
  </tbody>
</table>
