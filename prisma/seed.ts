...
async function main() {
  ...
  const factors: SeedFactor[] = [
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
      ...
      usageNotes: "Cross-sector EEIO average, per GBP spend. Approximation. DEFRA 2025. Unverified: DESNZ conversion factors do not include spend-based factors, so this value has no traceable source or price year and is not adjusted for inflation. Prefer an activity-based factor or supplier-specific data.",
    },
    {
      ...
      usageNotes: "Construction sector EEIO spend intensity, per GBP. DEFRA 2025. Unverified: DESNZ conversion factors do not include spend-based factors, so this value has no traceable source or price year and is not adjusted for inflation. Prefer an activity-based factor or supplier-specific data.",
    },
    {
      ...
      usageNotes: "IT services sector EEIO spend intensity, per GBP. DEFRA 2025. Unverified: DESNZ conversion factors do not include spend-based factors, so this value has no traceable source or price year and is not adjusted for inflation. Prefer an activity-based factor or supplier-specific data.",
    },
    {
      ...
      usageNotes: "Food & catering sector EEIO spend intensity, per GBP. DEFRA 2025. Unverified: DESNZ conversion factors do not include spend-based factors, so this value has no traceable source or price year and is not adjusted for inflation. Prefer an activity-based factor or supplier-specific data.",
    },
    ...
    // kg CO₂e per USD of spend. Values and price year unverified: EPA publishes
    // v1.3 per 6-digit NAICS in 2022 USD (scripts/build-useeio-factors.ts loads that).
    // ══════════════════════════════════════════════════════════════════════════
    {
      externalId: "useeio-v1.3-naics-111-crop-production",
      libraryId: epa.id, scope: 3, categoryCode: "s3-purchased-goods",
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 1.2340,
      usageNotes: "NAICS 111 — Crop Production. EPA USEEIO v1.3. kg CO₂e per USD spend. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 1.8910,
      usageNotes: "NAICS 112 — Animal Production. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 2.1560,
      usageNotes: "NAICS 211 — Oil and Gas Extraction. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.5430,
      usageNotes: "NAICS 236 — Construction of Buildings. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.9820,
      usageNotes: "NAICS 311 — Food Manufacturing. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 3.4720,
      usageNotes: "NAICS 324 — Petroleum & Coal Products. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 1.1450,
      usageNotes: "NAICS 325 — Chemical Manufacturing. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 1.6830,
      usageNotes: "NAICS 331 — Primary Metal Manufacturing. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.5210,
      usageNotes: "NAICS 336 — Transportation Equipment. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.7640,
      usageNotes: "NAICS 481 — Air Transportation. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.8910,
      usageNotes: "NAICS 484 — Truck Transportation. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.2340,
      usageNotes: "NAICS 518 — Data Processing, Hosting & Related. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.1820,
      usageNotes: "NAICS 531 — Real Estate. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.1650,
      usageNotes: "NAICS 541 — Professional & Technical Services. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.2910,
      usageNotes: "NAICS 621 — Ambulatory Health Care Services. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
    {
      ...
      activityType: "spend_based", geographyCountry: "US", inputUnit: "USD", uncertaintyRating: "high",
      co2e: 0.6730,
      usageNotes: "NAICS 722 — Food Services & Drinking Places. EPA USEEIO v1.3. Unverified: EPA publishes USEEIO v1.3 per 6-digit NAICS in 2022 USD; this 3-digit value has not been checked against that dataset, so no price year is set. Load the published factors with scripts/build-useeio-factors.ts.",
    },
  ];
  ...
  // DESNZ/DEFRA flat-file libraries, built by scripts/build-defra-factors.mjs.
  // Mirrors migrations 20260922000011 (2026.1) and 20260923000006 (2025.2) so
  // local databases match production: no effective-date window, plus 2025.1
  // factors DESNZ does not publish carried forward (unless DESNZ listed the
  // row with no value that year, in which case it is left out).
  type FlatFileData = {
    library: string;
    published: string;
    notPublished?: string[];
  ...
  const flatFiles: Array<[number, FlatFileData]> = [
    [2025, (await import("./data/defra-2025-factors.json")).default as FlatFileData],
    [2026, (await import("./data/defra-2026-factors.json")).default as FlatFileData],
  ];
  for (const [year, data] of flatFiles) {
    const version = data.library ?? `${year}.1`;
    const lib = await prisma.factorLibrary.upsert({
      where: { name_version: { name: "DEFRA", version } },
      update: {},
      create: {
        name: "DEFRA",
        version,
        license: "Open Government Licence v3.0",
        sourceUrl: `https://www.gov.uk/government/publications/greenhouse-gas-reporting-conversion-factors-${year}`,
        publishedAt: new Date(data.published ?? `${year}-07-10`),
      },
    });
    for (const f of data.factors) {
      const exists = await prisma.emissionFactor.findFirst({
        where: { factorLibraryId: lib.id, externalId: f.externalId },
        select: { id: true },
      });
      if (exists) continue;
    ...
    const replaced = new Set([...data.factors.map((f) => f.replacesExternalId), ...(data.notPublished ?? [])]);
    ...
    for (const f of carried) {
      ...
      await prisma.emissionFactor.create({
        data: {
          factorLibraryId: lib.id, externalId: f.externalId, scope: f.scope,
          ...
          usageNotes: `Carried forward from DEFRA 2025.1 (no DESNZ ${year} equivalent). ${f.usageNotes ?? ""}`,
        },
      });
      createdFactors++;
    }
