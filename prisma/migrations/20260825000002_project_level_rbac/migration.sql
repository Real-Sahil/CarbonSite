...
CREATE INDEX IF NOT EXISTS "project_role_assignments_organization_id_idx" ON "project_role_assignments"("organization_id");
CREATE INDEX IF NOT EXISTS "project_role_assignments_user_id_idx" ON "project_role_assignments"("user_id");
CREATE INDEX IF NOT EXISTS "project_role_assignments_project_id_idx" ON "project_role_assignments"("project_id");
CREATE INDEX IF NOT EXISTS "project_role_assignments_assigned_by_user_id_idx" ON "project_role_assignments"("assigned_by_user_id");
