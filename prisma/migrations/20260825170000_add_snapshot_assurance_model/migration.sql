...
CREATE TABLE "snapshot_assurances" (
  "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "snapshot_assurances_snapshot_id_key" ON "snapshot_assurances"("snapshot_id");

-- Create indexes for queries
CREATE INDEX "snapshot_assurances_organization_id_status_idx" ON "snapshot_assurances"("organization_id", "status");
CREATE INDEX "snapshot_assurances_auditor_user_id_status_idx" ON "snapshot_assurances"("auditor_user_id", "status");
