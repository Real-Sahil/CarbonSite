...
-- Configure pgAudit globally
ALTER DATABASE carbonsite SET pgaudit.log = 'ALL';
ALTER DATABASE carbonsite SET pgaudit.log_client = 'on';
ALTER DATABASE carbonsite SET pgaudit.log_catalog = 'off';
ALTER DATABASE carbonsite SET pgaudit.log_statement = 'all';
ALTER DATABASE carbonsite SET pgaudit.log_parameter = 'on';
