...
6. **CPI table** (`lib/calculation/price-index.ts`) — GBP checked against ONS Table 15a (D7BT annual averages) to 2025; 2012-2014 were wrong and are corrected. USD still needs checking against BLS CPI-U annual averages and its 2025 figure added. Add each year's figures when published (January).
