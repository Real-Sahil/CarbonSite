      ...
      <div className="flex flex-col gap-3">
        {distance !== null && (
          <div className="flex items-center gap-2 rounded-[10px] border border-[#e5e7eb] bg-[#f9fafb] px-3 py-2">
            <MapPin className="h-3.5 w-3.5 shrink-0 text-[#333333]" />
            <p className="text-sm text-[#222222] tracking-[-0.42px]">
              ...
              {distanceSource && (
                <span className="ml-1 text-xs text-[#333333]">
        ...
        {saved && (
          <p className="text-xs text-[#0f3e17] tracking-[-0.36px] flex items-center gap-1">
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="rounded-[10px] border border-[#e5e7eb] p-3 space-y-3">
        <p className="text-xs font-medium text-[#333333] tracking-[-0.36px] uppercase">
          Form values
        </p>
        {fields.map((field, idx) => (
          <div key={field.key} className="flex items-center gap-2">
            <label className="text-xs text-[#333333] tracking-[-0.36px] w-32 shrink-0 capitalize">
      ...
      <div className="rounded-[10px] border border-[#e5e7eb] p-3 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label className="text-xs text-[#333333] tracking-[-0.36px]">Pickup lat</label>
            <Input
              value={pickupLat}
          ...
          <div>
            <label className="text-xs text-[#333333] tracking-[-0.36px]">Pickup lng</label>
            <Input
              value={pickupLng}
          ...
          <div>
            <label className="text-xs text-[#333333] tracking-[-0.36px]">Delivery lat</label>
            <Input
              value={deliveryLat}
          ...
          <div>
            <label className="text-xs text-[#333333] tracking-[-0.36px]">Delivery lng</label>
            <Input
              value={deliveryLng}
