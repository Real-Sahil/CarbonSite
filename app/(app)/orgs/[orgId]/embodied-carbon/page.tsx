        ...
        <div className="max-w-[1200px] mx-auto px-8 py-8">
          <div className="flex items-start gap-3 mb-1">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#e1f4df] shrink-0 mt-0.5">
              <Layers className="h-4 w-4 text-[#0f3e17]" />
            </div>
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-medium tracking-wide text-[#0f3e17] uppercase">Carbon Accounting</span>
              </div>
            ...
            {records.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center px-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e1f4df] mb-4">
                  <Package className="h-6 w-6 text-[#0f3e17]" />
                </div>
                    ...
                    {records.map((record) => (
                      <TableRow key={record.id} className="border-b border-[#f3f4f6] hover:bg-[#f9fafb] transition-colors">
                        ...
                        <TableCell className="py-3.5 pr-6 text-right tabular-nums">
                          <span className="text-sm font-semibold text-[#0f3e17]">
...
function StatPill({
  ...
  const colors = { green: "bg-[#e1f4df] text-[#0f3e17]" };
