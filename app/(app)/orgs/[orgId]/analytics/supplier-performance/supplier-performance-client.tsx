...
export function SupplierPerformanceClient() {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Correlation between data quality and completeness scores across suppliers</CardDescription>
        </CardHeader>
        <CardContent>
          {scatterData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={250}>
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                ...
                <XAxis dataKey="quality" name="Quality Score" type="number" domain={[0, 100]} tick={{ fontSize: 12 }} label={{ value: "Quality Score", position: "insideBottom", offset: -10, fontSize: 12 }} />
                <YAxis dataKey="completeness" name="Completeness (%)" type="number" domain={[0, 100]} tick={{ fontSize: 12 }} label={{ value: "Completeness %", angle: -90, position: "insideLeft", fontSize: 12 }} />
