    ...
    >
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs text-[#333333] tracking-[-0.36px]">Contract</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs text-[#333333] tracking-[-0.36px]">Theme</label>
        ...
        {/* Measure picker */}
        <div className="flex flex-col gap-1">
          <label className="text-xs text-[#333333] tracking-[-0.36px]">Measure</label>
        ...
        {/* Quantity */}
        <div className="flex flex-col gap-1">
          <label className="text-xs text-[#333333] tracking-[-0.36px]">Quantity</label>
          <Input
            type="number"
            min="0.0001"
            step="any"
          ...
          />
          {computedValue !== null && (
            <p className="text-xs text-[#0f3e17] tracking-[-0.36px] font-medium">
      ...
      {/* Notes */}
      <div className="flex flex-col gap-1">
        <label className="text-xs text-[#333333] tracking-[-0.36px]">Notes (optional)</label>
        <Textarea
          value={notes}
