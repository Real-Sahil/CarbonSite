...
export default async function ImportBatchDetailPage({ params }: PageProps) {
  ...
  const person = await lookupPeople([batch.createdByUserId, batch.signedOffByUserId]);
  ...
  const serialized = {
    ...
    createdBy: person(batch.createdByUserId),
    signedOffBy: person(batch.signedOffByUserId),
  };
