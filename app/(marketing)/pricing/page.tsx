...
const tiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      { name: 'Field worker app', included: false },
      { name: 'Supplier portal', included: false },
      { name: 'Invoice sync', included: false },
      { name: 'Real-time SSE dashboard', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Field worker app (mobile OCR)', included: true },
      { name: 'Supplier portal', included: true },
      { name: 'Invoice sync (Xero, SAP, QB)', included: true },
      { name: 'Real-time SSE dashboard', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Invoice sync (Xero, SAP, QB)', included: true },
      { name: 'Real-time SSE dashboard', included: true },
      { name: 'SSO/SAML (Okta, Azure, Google)', included: true },
