...
export default function AcceptableUsePage() {
  return (
    <LegalShell title="Acceptable Use Policy" updated="Last updated: September 2026">
      <p>This Acceptable Use Policy ("AUP") applies to all users of the MetricOra platform and services, including web and mobile applications. Use of the platform constitutes acceptance of this policy.</p>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:security@metricora.co.uk">
                security@metricora.co.uk
              </a>{" "}
          ...
          <section>
            <h2>5. Field Worker and Mobile App Use</h2>
            <p>
