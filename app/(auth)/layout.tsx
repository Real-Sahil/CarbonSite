  ...
  return (
    <div className="min-h-[100dvh] flex">
      ...
      <div className="hidden lg:flex lg:w-[46%] xl:w-[44%] flex-col relative overflow-hidden shrink-0 bg-[#060612]">
        ...
        {/* Mesh gradient blobs */}
        <div className="absolute -top-32 -left-32 w-[480px] h-[480px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(13,148,136,0.5)_0%,transparent_65%)] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col h-full px-10 py-10">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-teal-500 to-cyan-500 shadow-[0_0_16px_rgba(13,148,136,0.5)]">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <p className="text-[10px] text-teal-400 font-mono uppercase tracking-[0.14em] mb-5">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-[#060612] px-6 py-12 min-h-[100dvh] relative overflow-hidden">
        ...
        <div className="lg:hidden mb-8 text-center relative z-10">
          <Link href="/" className="inline-flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 shadow-[0_0_16px_rgba(13,148,136,0.45)]">
